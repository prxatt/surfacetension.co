...
export function Logo({ className = 'w-12 h-12', position = 'left', variant = 'fixed' }: LogoProps) {
  ...
  const logoContent = (
    <motion.div
      className={`${positionClasses} z-[100] text-white/70 hover:text-white transition-colors cursor-pointer ${className}`}
      whileHover={{ scale: 1.1 }}
      transition={{ type: 'spring', stiffness: 400, damping: 17 }}
      role="img"
      aria-label="Surface Tension Logo"
    >
      <svg
