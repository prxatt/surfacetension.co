      ...
      <main className="relative min-h-screen bg-black">
        ...
        >
          ...
          >
            ...
            {homeData.subtitle && (
              <p className="mt-6 uppercase tracking-[0.2em] text-white/60 font-sans font-light" style={{ fontSize: 'clamp(0.75rem, 1.5vw, 1rem)', maxWidth: 'min(100%, 80vw)', width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' }}>
                {homeData.subtitle}
              </p>
            )}
          </div>
